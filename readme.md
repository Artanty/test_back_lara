## Решение тестового задания (php/laravel):

Есть сущность продукта.
Нужно:
Создать сущность заказа.
Сделать роут создания заказа используя id продукта и количество.
Сделать роут, чтобы получить заказы с продуктами, в том числе получить цены с переданной скидкой.
